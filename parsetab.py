...
_lr_productions = [
  ...
  ('instrucciones -> instruccion instrucciones','instrucciones',2,'p_instrucciones_lista','gramatica.py',85),
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones_lista','gramatica.py',86),
  ('instruccion -> CORIZQ expresion CORDER','instruccion',3,'p_instrucciones_evaluar','gramatica.py',89),
  ('expresion -> expresion MAS expresion','expresion',3,'p_expresion_binaria','gramatica.py',93),
  ('expresion -> expresion MENOS expresion','expresion',3,'p_expresion_binaria','gramatica.py',94),
  ('expresion -> expresion POR expresion','expresion',3,'p_expresion_binaria','gramatica.py',95),
  ('expresion -> expresion DIV expresion','expresion',3,'p_expresion_binaria','gramatica.py',96),
  ('expresion -> expresion AND expresion','expresion',3,'p_expresion_binaria','gramatica.py',97),
  ('expresion -> expresion OR expresion','expresion',3,'p_expresion_binaria','gramatica.py',98),
  ('expresion -> MENOS expresion','expresion',2,'p_expresion_unaria','gramatica.py',187),
  ('expresion -> NOT expresion','expresion',2,'p_expresion_unaria','gramatica.py',188),
  ('expresion -> PARIZQ expresion PARDER','expresion',3,'p_expresion_agrupacion','gramatica.py',202),
  ('expresion -> ENTERO','expresion',1,'p_expresion_number','gramatica.py',206),
  ('expresion -> DECIMAL','expresion',1,'p_expresion_number','gramatica.py',207),
  ('expresion -> CADENA','expresion',1,'p_expresion_number','gramatica.py',208),
]
